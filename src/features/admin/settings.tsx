  ...
  const handleSaveGeneral = () => {
    startTransition(async () => {
      await adminUpdateSystemSettings({
        ...
        maxSessionEndTime: (settings as any).maxSessionEndTime,
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div>
              ...
              <Input
                ...
                type="time"
                value={(settings as any).maxSessionEndTime ?? ""}
                onChange={(e) =>
                  setSettings({ ...(settings as any), maxSessionEndTime: e.target.value })
                }
              />
            </div>
            <div>
